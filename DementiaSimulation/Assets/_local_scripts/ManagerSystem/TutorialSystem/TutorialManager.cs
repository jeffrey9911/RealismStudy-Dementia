...
public class TutorialManager : MonoBehaviour
{
    ...
    [SerializeField] private GameObject TutorialButton6;
    ...
    [SerializeField] private GameObject PRO_L_GripTrigger;
    [SerializeField] private GameObject PRO_L_Joystick;
    [SerializeField] private GameObject PRO_L_Oculus;

    [SerializeField] private GameObject Q2_L_GripTrigger;
    [SerializeField] private GameObject Q2_L_Joystick;
    [SerializeField] private GameObject Q2_L_Oculus;
    ...
    [SerializeField] private GameObject PRO_R_GripTrigger;
    [SerializeField] private GameObject PRO_R_HandTrigger;
    [SerializeField] private GameObject PRO_R_Joystick;
    [SerializeField] private GameObject PRO_R_Oculus;

    [SerializeField] private GameObject Q2_R_GripTrigger;
    [SerializeField] private GameObject Q2_R_HandTrigger;
    [SerializeField] private GameObject Q2_R_Joystick;
    [SerializeField] private GameObject Q2_R_Oculus;
    ...
    private void Update()
    {
        if (TutorialStep > 0)
        {
            ...
            switch (TutorialStep)
            {
                ...
                case 8:
                    if (TutorialCounterUniversal >= 1.0f)
                    {
                        TriggerStepEnd();
                    }
                    break;
    ...
    public void StartTutorial()
    {
        ...
        RuntimeManager.Instance.UI_MANAGER.ActiveTutorialLevel();
        TriggerStep1();
    }
    ...
    private void TriggerStep8()
    {
        SwitchOff();

        TutorialCube.SetActive(true);
        TutorialCube.transform.position = new Vector3(1.847f, 2.592f, 0.9605f);
        TutorialCube.transform.rotation = Quaternion.Euler(0f, 26.579f, 0f);

        L_GripTrigger.SetActive(true);
        R_GripTrigger.SetActive(true);

        TutorialText.text = "Grip\nleft OR right grip trigger\nto grab things\nNow grab the cube\nand drop it on the green post";
    ...
    void SwitchOff()
    {
        ...
        PRO_L_GripTrigger.SetActive(false);
        PRO_L_Joystick.SetActive(false);
        PRO_L_Oculus.SetActive(false);

        Q2_L_GripTrigger.SetActive(false);
        Q2_L_Joystick.SetActive(false);
        Q2_L_Oculus.SetActive(false);
        ...
        PRO_R_GripTrigger.SetActive(false);
        PRO_R_HandTrigger.SetActive(false);
        PRO_R_Joystick.SetActive(false);
        PRO_R_Oculus.SetActive(false);

        Q2_R_GripTrigger.SetActive(false);
        Q2_R_HandTrigger.SetActive(false);
        Q2_R_Joystick.SetActive(false);
        Q2_R_Oculus.SetActive(false);
    }
    ...
    void TutorialUIFollow()
    {
        ...
        if ((isLeftHandTrigger || isRightHandTrigger) && TutorialStep >= 6 && TutorialStep != 8)
        {
    ...
    public void OnGOButtonClicked()
    {
        TutorialStep = -1;
        SwitchOff();
        RuntimeManager.Instance.UI_MANAGER.StartTask();
